...
Terrain::Terrain(unsigned int width,
    ...
    , _snow(Image(width,height,Color::RGB_32))
    , _heightmap(Image(width,height,Color::RGB_32))
    , _water(Image(width,height,Color::RGB_8))
    , _vegetation(Image(width,height,Color::RGB_8))
    , _rock(Image(width,height,Color::RGB_8))
    , _roads(Image(width,height,Color::RGB_8))
    , _houses(Image(width,height,Color::RGB_8))
{
