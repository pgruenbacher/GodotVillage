...
Mesh::Mesh(const Mesh &mesh)
		: _verticesArray(mesh._verticesArray), _texCoordsArray(mesh._texCoordsArray), _trianglesArray(mesh._trianglesArray), _verticesNormalsArray(mesh._verticesNormalsArray), _trianglesNormalsArray(mesh._trianglesNormalsArray), _linkedTriangles(mesh._linkedTriangles), _trianglesNeighbour(mesh._trianglesNeighbour) {
	_normals = false;
	_links = false;
	_neighbour = false;
}
