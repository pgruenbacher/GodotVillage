...
public:
	...
	virtual C evaluate(GraphArc<C, K, Vector3<C> > *arc,
		...
		*/
		...
		// TOTAL
		result = this->_usedRoad._travelWeight * travel + this->_usedRoad._slopeWeight * slope + this->_usedRoad._curvatureWeight * curvature + this->_usedRoad._waterWeight * water;
